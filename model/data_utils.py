...
class DataSet(object):
    ...
    def __init__(self, hparams):
        ...
        mean = augmentation_transform.MEANS
        std = augmentation_transform.STDS
    ...
    def next_batch(self):
        ...
        for data in images:
            ...
            final_img = augmentation_transform.apply_policy(
                epoch_policy, data)
            final_img = augmentation_transform.random_flip(
                augmentation_transform.zero_pad_and_crop(final_img, 4))
            # Apply cutout
            final_img = augmentation_transform.cutout_numpy(final_img)
